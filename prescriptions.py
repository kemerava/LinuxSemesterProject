...
def main(file_name_in, file_name_out_OH, file_name_out_OK):

   #sc = pyspark.SparkContext()
   #file_in = sc.textFile(file_name_in)
   #file_in.map()
   file_in = gzip.open(file_name_in, "rt")


   file_out_OH = open(file_name_out_OH, "wt")
   file_out_OK = open(file_name_out_OK, "wt")
   ...
   fields = line.split("\t")
   prev_name = fields[1].lower()+fields[2].lower()
   count = 0
   while line:
         ...
         if name == prev_name:
            ...
            if antidepressant in antidepressants:
               if state == "oh":
                  ...
                  print(last_name, first_name, count,  file = file_out_OK)
            count = 0
            prev_name = name 
         line = file_in.readline()
   file_in.close()
...
file_2015_OK = "OK_2015"
file_name_2016 = "PartD_Prescriber_PUF_NPI_Drug_2016.txt.gz"
file_2016_OH = "OH_2016"
file_2016_OK = "OK_2016"

main(file_name_2015, file_2015_OH, file_2015_OK)
main(file_name_2016, file_2016_OH, file_2016_OK)
